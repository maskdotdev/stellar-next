...
export function OpenAIIcon({ className = "w-6 h-6" }: AIIconProps) {
  return (
    <svg
...
export function AnthropicIcon({ className = "w-6 h-6" }: AIIconProps) {
  return (
    <svg
      className={`${className} text-black dark:text-white`}
      fill="currentColor"
...
export function GeminiIcon({ className = "w-6 h-6" }: AIIconProps) {
  return (
    <svg
      className={`${className} text-black dark:text-white`}
      height="1.5em"
...
export function GrokIcon({ className = "w-6 h-6" }: AIIconProps) {
  return (
    <svg
      className={`${className} text-black dark:text-white`}
      fill="currentColor"
...
export function OllamaIcon({ className = "w-6 h-6" }: AIIconProps) {
  return (
    <svg
      className={`${className} text-black dark:text-white`}
      fill="currentColor"
...
export function AzureIcon({ className = "w-6 h-6" }: AIIconProps) {
  return (
    <svg
      className={`${className} text-black dark:text-white`}
      fill="currentColor"
